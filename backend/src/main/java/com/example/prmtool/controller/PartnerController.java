...
import com.example.prmtool.service.PartnerCsvService; // 🆕 追加
...
public class PartnerController {
    ...
    private final PartnerCsvService partnerCsvService; // 🆕 追加

    public PartnerController(PartnerService partnerService,
            PartnerCsvService partnerCsvService) { // 🆕 修正
        this.partnerService = partnerService;
        this.partnerCsvService = partnerCsvService; // 🆕 追加
    }
